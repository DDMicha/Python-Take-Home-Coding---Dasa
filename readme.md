...
######WWhy was this technology stack chosen and implemented?
...
######WWhat are the pros/cons of this technology stack?
**pros**: 
    * Easy to use.
...
######WWhat are some alternatives to the implemented technology stack?
Sure, cloud services for example Databricks, EMR, HDInsight and also Hortonworks Data Platform or Cloudera.

######WWhat are their strength's and weaknesses?
**strength**:
   * Environment
   * Simplicit
